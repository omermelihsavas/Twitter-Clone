    ...
    return (
        <Link to="/" className="py-3 px-4 hover:bg-white/[0.03] transition-colors relative">
            ...
            <Popover className="absolute top-1.5 right-2">
                <Popover.Button className="w-[34.75px] h-[34.75px] outline-none text-[#71767b] rounded-full  flex items-center justify-center hover:bg-[#1d9bf01a] hover:text-[#1d9bf0] transition-colors">
                ...
                <Popover.Panel className="w-[384px] absolute grid top-2 right-0 bg-black shadow-box rounded-xl z-[1]">
                    ...
                    <button type="button" className="hover:bg-white/[0.05] transition-colors text-left py-3 px-4 flex items-center gap-3 text-[15px] leading-5 font-bold text-[#e7e9ea]">
                        ...
                        Bu gündem başlığı zaralı veya spam içeriyor
                    </button>
                </Popover.Panel>
            </Popover>
        </Link>
