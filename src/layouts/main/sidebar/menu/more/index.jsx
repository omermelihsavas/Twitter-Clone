...
export default function More() {
    return (
        <Popover className="relative">
            ...
            <div className="absolute bottom-[340px] left-0 z-10">
                <Popover.Panel className="w-[318px] absolute top-[100%] bg-black shadow-box rounded-xl overflow-hidden">
                    <button className="px-4 h-14 w-full inline-flex items-center gap-5 hover:bg-[#eff3f41a] transition-colors">
                        ...
                        <div className="pr-4 text-xl text-[#e7e9ea] font-bold">
                            Yer İşaretleri
                        </div>
                    </button>
                    ...
                    <div className="h-[2px] my-0.5 w-[90%] mx-auto bg-[#2f3336]" />

                    <Disclosure>
                        {({ open }) => (
                            <>
                                <Disclosure.Button className="px-4 h-[52px] text-[#e7e9ea] flex items-center justify-between w-full font-bold outline-none hover:bg-[#eff3f41a] transition-colors">
                                    İçerik Üreticisi Stüdyosu
                                    <svg viewBox="0 0 24 24" width={18.75} height={18.75} className={classNames("transition-all", {
                                ...
                                <Disclosure.Panel className="text-[#e7e9ea]">
                                    <Link to="/" className="px-3 h-11 gap-3 flex items-center text-[15px] font-medium hover:bg-[#eff3f41a] transition-colors">
                    ...
                    <Disclosure>
                        {({ open }) => (
                            <>
                                <Disclosure.Button className="px-4 h-[52px] flex items-center justify-between w-full font-bold outline-none hover:bg-[#eff3f41a] transition-colors">
                                    Profesyonel Araçlar
                                    <svg viewBox="0 0 24 24" width={18.75} height={18.75} className={classNames("transition-all", {
                                        "rotate-180 text-[#1d9bf0]": open
                                    })}>
